# -*- coding: utf-8 -*-
"""
Корневые сертификаты УЦ Минцифры России (Russian Trusted Root CA / Sub CA).

С 04.07.2026 сайт ЕИС (zakupki.gov.ru) использует отечественный TLS-сертификат,
выданный УЦ Минцифры. Этих сертификатов нет в стандартном наборе certifi,
поэтому без них requests падает с ошибкой CERTIFICATE_VERIFY_FAILED.

Источник (официальные ссылки Госуслуг):
  https://gu-st.ru/content/lending/russian_trusted_root_ca_pem.crt
  https://gu-st.ru/content/lending/russian_trusted_sub_ca_pem.crt

Внимание: существует ДВА промежуточных сертификата с одинаковым именем
"Russian Trusted Sub CA" — выпуска 2022 и 2024 года, с разными ключами.
Сайты могут быть выданы любым из них, поэтому встроены оба.

Russian Trusted Root CA действует до 27.02.2032,
Russian Trusted Sub CA (2022) — до 06.03.2027,
Russian Trusted Sub CA (2024) — до 19.07.2029 (после — обновить файл).
"""
